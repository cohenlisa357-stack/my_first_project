Kort beskrivning av mitt webbprojekt:
Hemsida som ger en överblick av mina hundar som används i terapeutiskt syfte.
Webbsidan har en hemsida med tre underliggande sidor.
De underliggande sidorna beskriver närmare varje hund och en kontakt sida med kontakt formulär och mejl adress.

Tekniker
Projektet är byggt med:
- HTML
- 
Projektet finns publicerat via:

- https://pawsitiviebond.vercel.app/
- (https://min-webbsida.onrender.com/index.html)

  Svar på frågor om versionshantering
  ...
  - för att exkludera en ny fil i projektet behöver du bara lägga in filnamnet i .gitignore och spara. är det en redan använd fil måste du säga till git att glömma bort filen utan att radera den. Kör git rm --cached kommandot och lägg til filen i .gitignore. gör en git commit -m "stop tracking namn_på_filen"
    ...
    Kontakt
    Om du har frågor hör av dig!
    Lisa Cohen
    cohenlisa357@gmail.com
